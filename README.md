...
It only copies the sql files to the docker container so that it creates and fills up the database when run. It also contains the environment variables (for now) to create the database.
